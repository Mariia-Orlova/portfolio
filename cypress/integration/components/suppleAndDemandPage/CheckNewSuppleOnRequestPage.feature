Feature:  Create new supple in Supple and Demand page and check this request on Supple and Demand page
  ...
  Scenario Outline: Create new supple with Products-Manually
    ...
    When Click on Supple on Request page
    Then Check Supple on Request field "<Title>"
    And Check field Supple "<Description>"
