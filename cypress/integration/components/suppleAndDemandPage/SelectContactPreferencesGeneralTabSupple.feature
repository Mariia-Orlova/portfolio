Feature:  Create new supple in Supple and Demand page and select some contact preferences
  ...
  Scenario Outline: Create new supple with Products-Manually
    ...
    And Select Contact preferences Email
    And Select Contact preferences Phone
