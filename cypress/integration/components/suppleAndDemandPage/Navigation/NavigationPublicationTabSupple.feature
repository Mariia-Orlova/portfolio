Feature:  Create new supple in Supple and Demand page and check navigation on Publication Tab
  ...
  Scenario Outline: Create new supple with Products-Manually
    ...
    And Check first condition of Navigation General tab
    ...
    And Check navigation General tab
    And Check first condition of Navigation Expertise tab
    And Fill data for Expertise tab
    And Check navigation Expertise tab
    And Check first condition of Navigation Products tab
